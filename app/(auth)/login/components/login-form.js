      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          ...
          <button
            ...
            className="absolute inset-y-2 right-0 flex items-center justify-center px-3 text-slate-500 hover:text-slate-900 dark:text-slate-400 dark:hover:text-white"
